...
Команда "Мишки Гамми" выражает благодарность разработчикам проекта [KodaCode](https://kodacode.ru/). Процентов на 90 делал Koda.Agent. Краткая история промтов в файле ai_log.md.
